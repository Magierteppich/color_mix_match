...
def img_get_feature(path_to_library): # returns a list of dictionary containing ALL image features.
...
def show_result_dict_path(path_to_library, n_init = 25, number_of_clusters = 5):
...
def mix_n_match (path_to_library, n_init = 25, number_of_clusters = 5):

    result_dict = show_result_dict_path(path_to_library, n_init = n_init, number_of_clusters = number_of_clusters)
